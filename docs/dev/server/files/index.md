...
Todos os arquivos **BUILDADOS** da docs estão nessa pasta:

```bash
/var/www/html/docs
```

Como nossa docs são arquivos html estáticos servimos ele de forma diferente, existe uma configuração no nginx que redireciona os paths com **/docs** para essa pasta e o roteamento da docs lida com o resto.
