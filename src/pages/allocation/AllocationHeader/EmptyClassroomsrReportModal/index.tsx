...
interface EmptyClassroomsReportModalProps extends ModalProps {
  buildings: BuildingResponse[];
}

function EmptyClassroomsReportModal({
  isOpen,
  onClose,
  buildings,
}: EmptyClassroomsReportModalProps) {
  const {
...
export default EmptyClassroomsReportModal;
